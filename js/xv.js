...
function typeWriter() {
  ...
  typed.innerHTML = done + (done ? "<br/>" : "") + txt[line].substring(0, ch);
...
function showSlide(n) {
  ...
  cont.querySelectorAll(".mariposa").forEach((b) => (b.style.display = "none"));
  ...
  cont.classList.remove("slide-0", "slide-1", "slide-2", "slide-3", "slide-4");
...
cont.addEventListener("click", (e) => {
  ...
  if (dir === "extra" && idx === current) console.log("Extra en slide", idx);
...
form.addEventListener("submit", function (e) {
  ...
  for (let i = 2; i <= cantidad; i++) {
    invitadosHTML += `
            <div class="form-group">
              ...
              <input type="text" name="invitado_${
                i - 1
  ...
  // Envío final
  document
    .getElementById("datos-invitados")
