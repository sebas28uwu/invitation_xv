...
// Música de fondo: play/pause y autoplay seguro
...
function updateMusicIcon() {
  iconMusic.textContent = isPlaying ? '🔊' : '🔇';
}
...
// Intentar autoplay tras interacción
...
music.addEventListener('play', () => { isPlaying = true; updateMusicIcon(); });
